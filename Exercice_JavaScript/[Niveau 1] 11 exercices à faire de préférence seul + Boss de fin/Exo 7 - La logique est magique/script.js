// voici la liste de votre équipement    // le point d'exclamation est un NOT ( ! )
var casque = false;
var epee = true;
var bouclier = false;
var gloire = false;
...
if ( casque  && epee  && bouclier   ) { //Ecrivez entre les parenthèses les tests correspondants
    ...
    gloire = true;
} else if( !casque && !epee && bouclier    ) { //Ecrivez entre les parenthèses les tests correspondants
